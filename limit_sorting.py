...
# AS OF 4/12, this sorting algorithm has been deprecated.
# We've transitioned from a limit switch approach to a hall sensor approach.
# Current sorting.py holds the most recent and active sorting algorithm
